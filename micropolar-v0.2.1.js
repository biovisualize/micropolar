    ...
    function exports(_container) {
        ...
        container.datum(data).each(function(_data, _index) {
            ...
            var ticksText = angularAxis.select("text.axis-text").attr({
                ...
                if (ticks) return ticks[d] + axisConfig.angularAxis.ticksSuffix; else return d + axisConfig.angularAxis.ticksSuffix;
            }).style(fontStyle);
    ...
    function exports() {
        ...
        container.datum(config).each(function(_config, _index) {
            ...
            generator.line = function(d, i, pI) {
                ...
                if (i > 0) return;
                var lineSelection = d3.select(this.parentNode).selectAll("path.mark.line").data([ 0 ]);
